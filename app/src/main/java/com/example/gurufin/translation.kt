...
class translation : Activity() {
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            spin1.adapter = ArrayAdapter(this, R.layout.simple_list_item_1, names)
            ...
            spin2.adapter = ArrayAdapter(this, R.layout.simple_list_item_1, names)
